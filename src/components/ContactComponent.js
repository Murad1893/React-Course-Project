...
//some functions that will help us to validate
const required = (val) => val && val.length; //this checks that the value is greater than 0
...
const isNumber = (val) => !isNaN(Number(val)); //the value is number
//regex to check whether email
//begins with alphanumeric then checks that there is '@' present. Then checking another number of alphanumeric values. Then a dot. Then maximum of 2 - 4 chars after the dot as .com or .org etc.
